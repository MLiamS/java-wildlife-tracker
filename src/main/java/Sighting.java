...
public class Sighting {
  ...
  public boolean equals(Object otherSighting) {
    if(!(otherSighting instanceof Sighting)) {
      ...
      return this.getAnimalId() == (newSighting.getAnimalId()) && this.getLocation().equals(newSighting.getLocation()) && this.getRangerName().equals(newSighting.getRangerName()) && this.getTimeStamp().equals(newSighting.getTimeStamp());
    }
  }
